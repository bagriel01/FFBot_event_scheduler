#Esse é o antigo flow de como o scheduler.py funcionava. Estou mantendo ele para fins de portfolio e comparação de evolução do código em relação a nova versão do bot!

import logging
from datetime import datetime as dt
from multiprocessing import context # isso não estava sendo utilizado
...
NEWPOST_TEXT, NEWPOST_PICTURES , FFPOST_DATE = range(3) #três estados diferentes sendo que apenas um estava sendo utilizado
